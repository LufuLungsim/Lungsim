...
if bFileState==1
    ...
    set(findall(handles.calibrationAdvancedPanel, '-property', 'enable'), 'enable', 'off')
    set(findall(handles.outputFormatPanel, '-property', 'enable'), 'enable', 'off')
    set(findall(handles.fileCalibration, '-property', 'enable'), 'enable', 'off')
else
    %%TODO alles obige entsperren
    set(findall(handles.calibrationAdvancedPanel, '-property', 'enable'), 'enable', 'on')
    set(findall(handles.outputFormatPanel, '-property', 'enable'), 'enable', 'on')
    set(findall(handles.fileCalibration, '-property', 'enable'), 'enable', 'on')
end
